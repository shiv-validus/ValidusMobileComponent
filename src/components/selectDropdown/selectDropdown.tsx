...
const SelectDropdown = (
  {
    ...
    onChangeSearchInputText /* function callback when the search input text changes, this will automatically disable the dropdown's internal search to be implemented manually outside the component  */,
  }: any,
  ref: any
) => {
  ...
  /* ******************* hooks ******************* */
  const { dropdownButtonRef, dropDownFlatlistRef }: any = useRefs();
  const {
    dataArr, //
    selectedItem,
    selectedIndex,
  ...
  const openDropdown = () => {
    dropdownButtonRef.current.measure(
      (_fx: any, _fy: any, w: any, h: any, px: any, py: any) => {
  ...
  const renderFlatlistItem = ({ item, index }: any): any => {
